...
export default function VerifyOTPScreen({ route, navigation }: Props) {
    ...
    const { requestPermissionAndStartTracking } = useTechnicianLocation();
        ...
        >
            ...
            <Animated.View style={[styles.section, { transform: [{ translateY: formTranslateY }] }]}>
                ...
                <TouchableOpacity onPress={handleVerify} disabled={verifying}>
                    <LinearGradient colors={["#1DA1F2", "#4B6CFF"]} style={styles.button}>
...
const styles = StyleSheet.create({
    ...
    topCard: { backgroundColor: "#fff", alignItems: "center", padding: 20, elevation: 5 },
    ...
    otpBoxFilled: { borderColor: "#4B6CFF", backgroundColor: "#EEF2FF" },
    ...
    row: { flexDirection: "row", justifyContent: "center", marginTop: 15 },
    muted: { color: "#777" },
    link: { color: "#2A7DE1", fontWeight: "700" },
    timerRow: { flexDirection: "row", justifyContent: "center", marginTop: 10, gap: 5 },
    timer: { color: "#777" },
